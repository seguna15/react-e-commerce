...
import { createAccessoryAction } from "../../../redux/slices/accessories/accessoriesSlices";
...
export default function AccessoryToAdd() {
  ...
  let {  loading } = useSelector((state) => state?.accessories);
  
  //onSubmit
  const handleOnSubmit = (e) => {
    e.preventDefault();
    dispatch(createAccessoryAction({name:formData?.name,file})) 
    setFormData({
      name: "",
      images: "",
    })
